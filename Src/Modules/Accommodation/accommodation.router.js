...
router.get('/GetAllAccommodations', auth(roles.ADMIN),
...
router.get('/RetrieveAllActiveAccommodations',asyncHandler(accommodationController.getAllActiveAccommodations));
...
router.patch('/ConfirmAccommodationPublished/:id',auth(roles.ADMIN),
asyncHandler(accommodationController.confirmAccommodationPublished));
